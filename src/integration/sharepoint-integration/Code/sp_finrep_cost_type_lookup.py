...
if response.status_code == 200:
    ...
    try:
        ...
        sheet =  wb['Cost Type'] #wb.active  # Or wb['Sheet1']
...
# Rename the first column 'None' to 'Cost Type'
df.columns = ['Cost_Type']

df = df[df['Cost_Type'] != 'Cost Type']

spark_df = spark.createDataFrame(df)

# COMMAND ----------

load_data(spark_df, HIVE_SAP_4_HANA, "s4h_cost_type_key_lookup")